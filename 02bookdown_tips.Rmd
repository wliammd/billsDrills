...
```{r}
# Package names
packages <- c("tidyverse", "knitr", "formatR", "bookdown", "tufte", "forcats", "gapminder", "skimr", "ggridges", "personograph", "assertive", "plotly", "ggfortify", "Rtsne", "tidycensus", "caret", "rpart", "MASS", "caTools", "C50", "modeldata", "credentials")
