...
**Root mean squared error**, `RMSE`, is an important concept in regression problems. For a review of what is meant by `RMSE`, see this Wikipedia page: <https://en.wikipedia.org/wiki/Root-mean-square_deviation>. It's worth taking a more careful look at RMSE, and practicing with it, to illustrate the underlying methods of regression before we get into **caret**. 
