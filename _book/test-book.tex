...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-9-2.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-2.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-3.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-4.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-5.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-6.pdf}
...
\includegraphics{test-book_files/figure-latex/unnamed-chunk-12-7.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ed_exp3 <-}\StringTok{ }\NormalTok{education[}\KeywordTok{which}\NormalTok{(education}\OperatorTok{$}\NormalTok{Region }\OperatorTok{==}\StringTok{ }\DecValTok{2}\NormalTok{),}\KeywordTok{names}\NormalTok{(education) }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"State"}\NormalTok{,}\StringTok{"Minor.Population"}\NormalTok{,}\StringTok{"Education.Expenditures"}\NormalTok{)]}
\end{Highlighting}
\end{Shaded}
